...
public class DayOfWeekBasedAccessInterceptor extends HandlerInterceptorAdapter{
	...
	public boolean preHandle(HttpServletRequest request,
		...
		Calendar cal = Calendar.getInstance(); 
			...
			if(dayOfWeek == 4) { // 1 means Sunday, 2 means Monday....7 means Saturday
				
				response.getWriter().write("The Website is closed on T; please try accessing it " +
						"on any other week day!!");
				System.out.println("HandlerInterceptorAdapter : Spring MVC called PreHandler method for "
